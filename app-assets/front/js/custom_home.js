...
$(document).ready(function() {
	...
	function headerSticky(){
		...
		if( windowPos>20){
			...
			$(".main-navigation ul li #servicesNav").css('color', '#05182b');
			$(".main-navigation ul li #home").css('color', '#05182b');
			...
			$(".main-navigation ul li #servicesNav").css('color', '#ffffff');
			$(".main-navigation ul li #home").css('color', '#ffffff');
	...
	win.on("scroll", function () {
			...
			if (win.scrollTop() >= $("#kegiatan").offset().top - 430) {
				$(".main-navigation ul li #servicesNav").css('color', '#7a14ff');
			}
	...
	$("section").each(function () {
		if (smallwin.scrollTop() >= $(this).offset().top - 140) {
			$(".slicknav_menu li a").css('color', '#05182b');
			
		}
	});
	smallwin.on("scroll", function () {
		if (win.scrollTop() >= $("#home").offset().top - 100) {
			$(".slicknav_menu a[href='#kegiatan']").css('color', '#05182b');
		}
		if (win.scrollTop() >= $("#kegiatan").offset().top - 340) {
			$(".slicknav_menu a[href='#kegiatan']").css('color', '#7a14ff');
		}
	});
